              ...
              <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-3 bg-white border-b border-gray-200">
                  <div class="row">
                    ...
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="text" id="shipname" name="type" style="border-radius:5px;">
                    </div>
                    {{-- <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                    ...
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="time" id="shipname" name="departure" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Destination : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="text" id="shipname" name="destination" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Pickup Time : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="time" id="shipname" name="pickuptime" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Carrier : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="text" id="shipname" name="Carrier" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Origin : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="text" id="shipname" name="origin" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Pickup Date : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="date" id="shipname" name="pickupdate" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Expected Delivery Date : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <input type="date" id="shipname" name="expectdate" style="border-radius:5px;">
                    </div>
                    <div class="col-md-4 col-6 pt-2" style="text-align:right; ">
                      Comments : 
                    </div>
                    <div class="col-md-8 col-6" style="text-right: left">
                      <textarea id="shipname" name="comment" style="border-radius:5px;"></textarea>
                    </div>
                  </div>
                </div>
              </div>
